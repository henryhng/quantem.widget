...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from quantem.widget.transfer_function_editor import TransferFunctionEditor
...
_EXPORTS = {
    ...
    "TransferFunctionEditor": ("quantem.widget.transfer_function_editor", "TransferFunctionEditor"),
